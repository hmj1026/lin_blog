...
function ThemeToggleInner() {
  ...
  return (
    <button
      onClick={cycleTheme}
      className="flex h-9 w-9 items-center justify-center rounded-full border border-line bg-white text-primary transition hover:border-primary/40 dark:border-base-200 dark:bg-base-100"
