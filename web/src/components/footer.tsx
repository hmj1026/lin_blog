...
export async function Footer() {
  ...
  return (
    <footer className="mt-20 border-t border-line bg-white/90 backdrop-blur">
      <div className="section-shell grid gap-12 py-12 md:grid-cols-[1.2fr_1fr_1fr]">
        ...
        <div>
          ...
          <div className="mt-4 grid gap-2 text-sm text-base-300">
            {quickLinks.map((link) => (
        ...
        <div id="footer-contact" className="space-y-3">
          ...
          <Link
            ...
            className="inline-flex w-fit items-center gap-2 rounded-full bg-primary px-4 py-2 text-sm font-semibold text-white shadow-card transition hover:-translate-y-0.5"
          >
            hello@lin.blog
          </Link>
        </div>
      </div>
      <div className="border-t border-line/70 py-4 text-center text-xs text-base-300">
