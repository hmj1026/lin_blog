          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-wrap gap-4">
              <div>
                ...
                <div className="text-xs text-base-300">篇文章</div>
              </div>
              <div>
                <div className="text-2xl font-display text-primary">{categories.length}</div>
                <div className="text-xs text-base-300">分類</div>
              </div>
              <div>
                <div className="text-2xl font-display text-primary">{tags.length}</div>
                <div className="text-xs text-base-300">標籤</div>
              </div>
            </div>
          </div>
          <div className="rounded-3xl border border-line bg-base-50 p-6 shadow-card">
            <SectionHeader
              eyebrow="篩選"
              title="找到你要的主題"
              description="從分類或標籤開始，快速進入最相關的文章。"
            />
